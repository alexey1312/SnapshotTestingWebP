...
public extension Diffing where Value == UIImage {
    ...
    static func imageWebP(
        ...
        return Diffing(
            ...
            diff: { old, new in
                guard let message = compareWebP(old, new,
                                            precision: precision,
...
private func compareWebP(
    ...
    guard
        let webpData = new.webpData(compressionQuality: compressionQuality.rawValue),
        let newerCgImage = UIImage(data: webpData)?.cgImage,
